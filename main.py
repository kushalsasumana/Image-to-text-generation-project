...
while True:
    ...
    if pressed_key == 27:
        ...
        cv2.imwrite(r"C:\Users\sasum\OneDrive\Desktop\output\scanned_" + str(count) + ".jpg", processed)
        count += 1
        ...
        file = open(r"C:\Users\sasum\OneDrive\Desktop\output\recognized_" + str(count - 1) + ".txt", "w")
